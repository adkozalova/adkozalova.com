...
export default function PageProjectExhibitionFragile() {
    ...
    return (
        <>
            ...
            />
            <PageProjectExhibitionFragileContentBlock/>
            <ProjectBlock items={ProjectsData().personalExhibitionFragile}/>
        </>
    )
}

export function PageProjectExhibitionFragileContentBlock() {
    const [t] = useTranslation();
    return (
                            ...
                            <div className="blog_single_item">
                                ...
                                <div className="blog_simg_img">
                                    <a className="stretched-link text-info" href="https://www.facebook.com/events/1665819606925345/"
                                       ...
                                       rel="noopener noreferrer">
                                        <img src={require("../../assets/images/project/personal-exhibition-fragile/gallery.jpg")}
                                             className="img-fluid"
                                ...
                                <Trans i18nKey={"ProjectExhibitionFragileContent.text"}>
                                    ...
                                    <p><b>Dates:</b> 08.10.2020-28.10.2020 (Mo-Fr: 11:00-20:00; Sa: 12:00-20:00)<br/>
                                        ...
                                        <b>Location:</b> Kyiv, Ukraine - <a className="stretched-link text-info"
